...
export const zoomLevelCalculation = (bounds: LatLngBounds) => {
...
export const getBounds = (object: Raster | WMS | null): LatLngBounds => {
...
export const convertToLatLngBounds = (spatialBounds: number[][] | null) => {
    const bounds = spatialBounds ? {
        ...
        south: spatialBounds[1][0],
        west: spatialBounds[0][1]
    } : {
        north: 85,
        east: 180,
        south: -85,
